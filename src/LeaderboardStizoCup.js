...
function LeaderboardReddyshRoyale() {
    ...
    const [page, setPage] = useState([0, 10]) // Changer le nombres d'équipes par page
    const [teamsPerPage, setTeamsPerPage] = useState(10) // Changer le nombres d'équipes par page
